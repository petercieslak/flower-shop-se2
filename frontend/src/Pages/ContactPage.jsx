...
<div class="container px-40 py-24 mx-aut flex-auto">
    <div class=" border-2 border-[#3B1F2B] bg-[#F8F2E9] rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-2xl">
      ...
      <button class="text-white bg-[#014325] border-0 py-2 px-6 focus:outline-none" onClick={() => navigate("/products")}>Send</button>
    </div>
  </div>
    </div>
  );
